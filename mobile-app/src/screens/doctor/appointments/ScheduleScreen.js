    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.scheme.background }]}>
      <View style={styles.content}>
        <Card style={styles.placeholderCard}>
          <Icon name="schedule" size={60} color={theme.colors.doctor.primary} style={styles.icon} />
          <Text style={[styles.title, { color: theme.scheme.text }]}>Schedule Management</Text>
          <Text style={[styles.description, { color: theme.scheme.textSecondary }]}>
            Doctor schedule and appointment management will be implemented here
          </Text>
        </Card>
      </View>
    </SafeAreaView>
