    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.scheme.background }]}>
      <View style={styles.content}>
        <Card style={styles.placeholderCard}>
          <Icon name="psychology" size={60} color={theme.colors.doctor.primary} style={styles.icon} />
          <Text style={[styles.title, { color: theme.scheme.text }]}>AI-Assisted Diagnosis</Text>
          <Text style={[styles.description, { color: theme.scheme.textSecondary }]}>
            AI-powered dental diagnosis tools will be implemented here
          </Text>
        </Card>
      </View>
    </SafeAreaView>
