      ...
      <SafeAreaView style={{ flex: 1 }}>
        <Animated.ScrollView
            ...
            <View style={{ backgroundColor: '#FFFFFF', borderRadius: 24, padding: 20, shadowColor: '#483AA0', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.12, shadowRadius: 20, elevation: 8, borderWidth: 1, borderColor: '#F0F0F0' }}>
              {dashboardData.todayAppointments.map((appointment, index) => (
                <TouchableOpacity key={appointment.id} activeOpacity={0.7}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 16, paddingHorizontal: 4, borderBottomWidth: index < dashboardData.todayAppointments.length - 1 ? 1 : 0, borderBottomColor: '#F8F8F8', borderRadius: 12, marginBottom: index < dashboardData.todayAppointments.length - 1 ? 8 : 0 }}>
                    <View style={{ width: 48, height: 48, borderRadius: 24, overflow: 'hidden', marginRight: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 }}>
                    ...
                    <View style={{ alignItems: 'flex-end' }}>
                      ...
                      {appointment.status === 'Waiting' && (
                        <TouchableOpacity style={{ backgroundColor: '#483AA0', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 8, marginTop: 10, shadowColor: '#483AA0', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 3 }}>
          ...
          <View style={{ marginBottom: 32 }}>
            ...
            <TouchableOpacity
              activeOpacity={0.95}
              style={{ backgroundColor: '#FFFFFF', borderRadius: 28, padding: 28, shadowColor: '#667eea', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.15, shadowRadius: 24, elevation: 12, borderWidth: 1, borderColor: '#F0F4FF', transform: [{ scale: 1 }] }}
            >
              <LinearGradient
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 24 }}>
                <LinearGradient
                  ...
                  style={{ width: 64, height: 64, borderRadius: 32, justifyContent: 'center', alignItems: 'center', marginRight: 18, shadowColor: '#667eea', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 8 }}
                >
                  <MaterialIcons name="psychology" size={32} color="white" />
                  <View style={{ position: 'absolute', top: -2, right: -2, width: 20, height: 20, borderRadius: 10, backgroundColor: '#4CAF50', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'white' }}>
              ...
              <View style={{ backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 20, padding: 24, marginBottom: 24, borderWidth: 1, borderColor: 'rgba(102, 126, 234, 0.1)', shadowColor: '#667eea', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 }}>
                <View style={{ marginBottom: 20 }}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                    ...
                    <LinearGradient
                      ...
                      style={{ paddingHorizontal: 16, paddingVertical: 8, borderRadius: 16, shadowColor: '#FF6B35', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 3 }}
                    >
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <LinearGradient
                      ...
                      style={{ paddingHorizontal: 16, paddingVertical: 8, borderRadius: 16, shadowColor: '#4CAF50', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 3 }}
                    >
                ...
                <LinearGradient
                  colors={['#667eea', '#764ba2']}
                  style={{ borderRadius: 16, padding: 20, shadowColor: '#667eea', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 }}
                >
              ...
              <View style={{ flexDirection: 'row', gap: 16, marginTop: 8 }}>
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={{ flex: 1, borderRadius: 18, paddingVertical: 16, paddingHorizontal: 24, alignItems: 'center', shadowColor: '#667eea', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 }}
                >
                  <LinearGradient
                    colors={['#667eea', '#764ba2']}
                ...
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={{ backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 18, paddingVertical: 16, paddingHorizontal: 20, alignItems: 'center', borderWidth: 2, borderColor: '#667eea', shadowColor: '#667eea', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 4 }}
                >
          ...
          <View style={{ marginBottom: 28 }}>
            ...
            <View style={{ backgroundColor: '#FFFFFF', borderRadius: 24, padding: 20, shadowColor: '#483AA0', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.08, shadowRadius: 20, elevation: 6, borderWidth: 1, borderColor: '#F0F0F0' }}>
              {dashboardData.chatSummary.map((chat, index) => (
                <TouchableOpacity key={chat.id} activeOpacity={0.7}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 16, paddingHorizontal: 4, borderBottomWidth: index < dashboardData.chatSummary.length - 1 ? 1 : 0, borderBottomColor: '#F8F8F8', borderRadius: 12, marginBottom: index < dashboardData.chatSummary.length - 1 ? 8 : 0, backgroundColor: chat.unread ? '#F8F9FF' : 'transparent' }}>
                    <View style={{ width: 48, height: 48, borderRadius: 24, overflow: 'hidden', marginRight: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2, borderWidth: chat.unread ? 2 : 1,
