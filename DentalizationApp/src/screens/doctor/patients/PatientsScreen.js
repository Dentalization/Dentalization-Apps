    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.scheme.background }]}>
      <View style={styles.content}>
        <Card style={styles.placeholderCard}>
          <Icon name="people" size={60} color={theme.colors.doctor.primary} style={styles.icon} />
          <Text style={[styles.title, { color: theme.scheme.text }]}>Patient Management</Text>
          <Text style={[styles.description, { color: theme.scheme.textSecondary }]}>
            Patient list and management tools will be implemented here
          </Text>
        </Card>
      </View>
    </SafeAreaView>
