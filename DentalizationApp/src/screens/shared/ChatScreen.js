    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.scheme.background }]}>
      <View style={styles.content}>
        <Card style={styles.placeholderCard}>
          <Icon name="chat" size={60} color={theme.colors.success} style={styles.icon} />
          <Text style={[styles.title, { color: theme.scheme.text }]}>Chat</Text>
          <Text style={[styles.description, { color: theme.scheme.textSecondary }]}>
            Real-time messaging between patients and doctors will be implemented here
          </Text>
        </Card>
      </View>
    </SafeAreaView>
